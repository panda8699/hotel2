...
CREATE TABLE IF NOT EXISTS `bedstype` (
  ...
  `bedstypetitle` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `booked_details` (
  ...
  `booking_type` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `booking_source` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `booking_source_no` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `extracheckin` text COLLATE utf8_general_ci DEFAULT NULL,
  `extracheckout` text COLLATE utf8_general_ci DEFAULT NULL,
  `arival_from` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `purpose` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `extra_facility_days` text COLLATE utf8_general_ci DEFAULT NULL,
  `extrabed` text COLLATE utf8_general_ci DEFAULT NULL,
  `extraperson` text COLLATE utf8_general_ci DEFAULT NULL,
  `extrachild` text COLLATE utf8_general_ci DEFAULT NULL,
  `complementary` text COLLATE utf8_general_ci DEFAULT NULL,
  `complementaryprice` text COLLATE utf8_general_ci DEFAULT NULL,
  `discountreason` text COLLATE utf8_general_ci DEFAULT NULL,
  `discountamount` decimal(10,2) DEFAULT NULL,
  `commissionpersent` int(11) DEFAULT NULL,
  `commissionamount` decimal(10,2) DEFAULT NULL,
  `payment_method` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `advance_amount` decimal(10,2) DEFAULT NULL,
  `advance_remarks` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `booked_info` (
  ...
  `booking_number` varchar(100) COLLATE utf8_general_ci NOT NULL,
  `date_time` datetime NOT NULL,
  `roomid` text COLLATE utf8_general_ci NOT NULL,
  `nuofpeople` varchar(100) COLLATE utf8_general_ci DEFAULT '0',
  `children` text COLLATE utf8_general_ci DEFAULT NULL,
  `total_room` int(11) NOT NULL DEFAULT 0,
  `room_no` varchar(45) COLLATE utf8_general_ci NOT NULL,
  `roomrate` text COLLATE utf8_general_ci DEFAULT NULL,
  `promocode` text COLLATE utf8_general_ci DEFAULT NULL,
  `total_price` decimal(10,2) NOT NULL DEFAULT 0.00,
  `paid_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `offer_discount` varchar(100) COLLATE utf8_general_ci NOT NULL DEFAULT '0.00',
  `full_guest_name` text COLLATE utf8_general_ci DEFAULT NULL,
  `special_request` text COLLATE utf8_general_ci DEFAULT NULL,
  `coments` text COLLATE utf8_general_ci DEFAULT NULL,
  `checkindate` datetime NOT NULL,
  `checkoutdate` datetime NOT NULL,
  `cutomerid` int(11) NOT NULL,
  `bookingstatus` varchar(255) COLLATE utf8_general_ci NOT NULL COMMENT '0=pending,1=cancel,2=success,3=finish,4=checkin,5=checkout',
...
CREATE TABLE IF NOT EXISTS `bookingtype` (
  ...
  `booktypetitle` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `candidate_basic_info` (
  ...
  `alter_phone` varchar(20) CHARACTER SET utf8 NOT NULL,
  `present_address` varchar(100) CHARACTER SET utf8 NOT NULL,
  `parmanent_address` varchar(100) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `candidate_education_info` (
  ...
  `degree_name` varchar(30) CHARACTER SET utf8 NOT NULL,
  `university_name` varchar(50) CHARACTER SET utf8 NOT NULL,
  `cgp` varchar(30) CHARACTER SET utf8 NOT NULL,
  `comments` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `sequencee` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `candidate_interview` (
  ...
  `can_id` varchar(30) CHARACTER SET utf8 NOT NULL,
  `job_adv_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `interview_date` varchar(30) CHARACTER SET utf8 NOT NULL,
  `interviewer_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `interview_marks` varchar(50) CHARACTER SET utf8 NOT NULL,
  `written_total_marks` varchar(50) CHARACTER SET utf8 NOT NULL,
  `mcq_total_marks` varchar(50) CHARACTER SET utf8 NOT NULL,
  `total_marks` varchar(30) NOT NULL,
  `recommandation` varchar(50) CHARACTER SET utf8 NOT NULL,
  `selection` varchar(50) CHARACTER SET utf8 NOT NULL,
  `details` varchar(50) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `candidate_selection` (
  ...
  `pos_id` varchar(30) CHARACTER SET utf8 NOT NULL,
  `selection_terms` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `candidate_shortlist` (
  ...
  `date_of_shortlist` varchar(50) CHARACTER SET utf8 NOT NULL,
  `interview_date` varchar(30) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `candidate_workexperience` (
  ...
  `working_period` varchar(50) CHARACTER SET utf8 NOT NULL,
  `duties` varchar(30) CHARACTER SET utf8 NOT NULL,
  `supervisor` varchar(50) CHARACTER SET utf8 NOT NULL,
  `sequencee` varchar(10) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `customerinfo` (
  ...
  `customernumber` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `fathername` text COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `isnationality` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `pid` text COLLATE utf8_general_ci DEFAULT NULL,
  `pitype` text COLLATE utf8_general_ci DEFAULT NULL,
  `imgfront` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `imgback` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `imgguest` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `contacttype` text COLLATE utf8_general_ci DEFAULT NULL,
  `zipcode` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `nationality` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `passport` varchar(120) COLLATE utf8_general_ci DEFAULT NULL,
  `visano` varchar(80) COLLATE utf8_general_ci DEFAULT NULL,
  `purpose` varchar(80) COLLATE utf8_general_ci DEFAULT NULL,
  `profileimage` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `city` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `gender` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `dob` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `anniversary` text COLLATE utf8_general_ci DEFAULT NULL,
  `country` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `username` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `cust_phone` text COLLATE utf8_general_ci DEFAULT NULL,
  `pass` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `balance` decimal(10,2) NOT NULL DEFAULT 0.00,
  `active` int(255) DEFAULT NULL,
  `password_reset_token` text COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `employee_performance` (
  ...
  `employee_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `note` varchar(50) CHARACTER SET utf8 NOT NULL,
  `date` varchar(50) CHARACTER SET utf8 NOT NULL,
  `note_by` varchar(50) CHARACTER SET utf8 NOT NULL,
  `number_of_star` varchar(50) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `employee_salary_payment` (
  ...
  `employee_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `total_salary` varchar(50) CHARACTER SET utf8 NOT NULL,
  `total_working_minutes` varchar(50) CHARACTER SET utf8 NOT NULL,
  `working_period` varchar(50) CHARACTER SET utf8 NOT NULL,
  `payment_due` varchar(50) CHARACTER SET utf8 NOT NULL,
  `payment_date` varchar(50) CHARACTER SET utf8 NOT NULL,
  `paid_by` varchar(50) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `employee_salary_setup` (
  ...
  `salary_type_id` varchar(30) CHARACTER SET utf8 NOT NULL,
  `amount` varchar(30) CHARACTER SET utf8 NOT NULL,
  `create_date` date DEFAULT NULL,
  `update_date` datetime(6) DEFAULT NULL,
  `update_id` varchar(30) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `employee_sal_pay_type` (
  ...
  `payment_period` varchar(50) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `emp_attendance` (
  ...
  `sign_in` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `sign_out` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `grand_loan` (
  ...
  `employee_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `permission_by` varchar(30) CHARACTER SET utf8 NOT NULL,
  `loan_details` varchar(30) CHARACTER SET utf8 NOT NULL,
  `amount` varchar(30) CHARACTER SET utf8 NOT NULL,
  `interest_rate` varchar(30) CHARACTER SET utf8 NOT NULL,
  `installment` varchar(30) CHARACTER SET utf8 NOT NULL,
  `installment_period` varchar(30) CHARACTER SET utf8 NOT NULL,
  `repayment_amount` varchar(30) CHARACTER SET utf8 NOT NULL,
  `date_of_approve` varchar(30) CHARACTER SET utf8 NOT NULL,
  `repayment_start_date` varchar(30) CHARACTER SET utf8 NOT NULL,
  `created_by` varchar(30) CHARACTER SET utf8 NOT NULL,
  `updated_by` varchar(30) CHARACTER SET utf8 NOT NULL,
  `loan_status` varchar(30) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`loan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `job_advertisement` (
  ...
  `pos_id` varchar(30) CHARACTER SET utf8 NOT NULL,
  `adv_circular_date` varchar(30) CHARACTER SET utf8 NOT NULL,
  `circular_dadeline` varchar(30) CHARACTER SET utf8 NOT NULL,
  `adv_file` tinytext CHARACTER SET utf8 NOT NULL,
  `adv_details` varchar(255) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `loan_installment` (
  ...
  `employee_id` varchar(21) CHARACTER SET utf8 NOT NULL,
  `loan_id` varchar(21) CHARACTER SET utf8 NOT NULL,
  `installment_amount` varchar(20) CHARACTER SET utf8 NOT NULL,
  `payment` varchar(20) CHARACTER SET utf8 NOT NULL,
  `date` varchar(20) CHARACTER SET utf8 NOT NULL,
  `received_by` varchar(20) CHARACTER SET utf8 NOT NULL,
  `installment_no` varchar(20) CHARACTER SET utf8 NOT NULL DEFAULT '1',
  `notes` varchar(80) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `payroll_holiday` (
  ...
  `holiday_name` varchar(30) CHARACTER SET utf8 NOT NULL,
  `start_date` varchar(30) CHARACTER SET utf8 NOT NULL,
  `end_date` varchar(30) CHARACTER SET utf8 NOT NULL,
  `no_of_days` varchar(30) CHARACTER SET utf8 NOT NULL,
  `created_by` varchar(30) CHARACTER SET utf8 NOT NULL,
  `updated_by` varchar(30) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `payroll_tax_setup` (
  ...
  `start_amount` varchar(30) CHARACTER SET utf8 NOT NULL,
  `end_amount` varchar(30) CHARACTER SET utf8 NOT NULL,
  `rate` varchar(30) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `position` (
  ...
  `position_details` varchar(255) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`pos_id`)
...
CREATE TABLE IF NOT EXISTS `roomdetails` (
  ...
  `roomtype` varchar(255) COLLATE utf8_general_ci NOT NULL,
  `roomsize` int(11) NOT NULL,
  `roomsizemesurement` varchar(255) COLLATE utf8_general_ci NOT NULL,
  `roomactive` int(11) NOT NULL,
  `bedsno` int(11) NOT NULL,
  `bedstype` int(255) NOT NULL,
  `number_of_star` int(10) DEFAULT 4,
  `roomdescription` varchar(255) COLLATE utf8_general_ci NOT NULL,
  `reservecondition` text COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `roomfacilitydetails` (
  ...
  `facilitytitle` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `roomfacilitytype` (
  ...
  `facilitytypetitle` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `roomsizemesurement` (
  ...
  `roommesurementitle` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `room_image` (
  ...
  `room_id` int(11) NOT NULL,
  `room_imagename` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `salary_setup_header` (
  ...
  `employee_id` varchar(30) CHARACTER SET utf8 NOT NULL,
  `salary_payable` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `absent_deduct` varchar(30) CHARACTER SET utf8 NOT NULL,
  `tax_manager` varchar(30) CHARACTER SET utf8 NOT NULL,
  `status` varchar(30) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `salary_sheet_generate` (
  ...
  `start_date` varchar(30) CHARACTER SET utf8 NOT NULL,
  `end_date` varchar(30) CHARACTER SET utf8 NOT NULL,
  `generate_by` varchar(30) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`ssg_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `salary_type` (
  ...
  `sal_name` varchar(50) CHARACTER SET utf8 NOT NULL,
  `emp_sal_type` varchar(50) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `starclass` (
  ...
  `starclassname` varchar(50) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `weekly_holiday` (
  ...
  `dayname` varchar(30) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`wk_id`)
