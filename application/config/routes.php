...
*/
$apiVersion = 'v1'; // Just change this for version upgrades

$route["api/$apiVersion/login"] = "dashboard/auth/index";
$route["api/$apiVersion/loginsubmit"] = "hotel/loginsubmit";
$route["api/$apiVersion/signup"] = 'hotel/signup';
$route["api/$apiVersion/smart-door"] = 'hotel/smart_door';
$route["api/$apiVersion/smart-door/register-device"] = 'hotel/registerDevice';
$route["api/$apiVersion/smart-door/change-lock"] = 'hotel/controlSmartLock';
$route["api/$apiVersion/smart-door/update-status"] = 'hotel/update_device_status';
...
$route['room_setting/list-room-device'] = "room_setting/floorplan/listRoomDevice";
