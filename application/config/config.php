...
if (isset($_SERVER["REQUEST_URI"])) {
    if ((stripos($_SERVER["REQUEST_URI"], '/app') === FALSE) && (stripos($_SERVER["REQUEST_URI"], '/api_handler_v2') === FALSE) && (stripos($_SERVER["REQUEST_URI"], '/dashboard/setting/create') === FALSE) && (stripos($_SERVER["REQUEST_URI"], '/api') === FALSE)) {
        $config['csrf_protection'] = TRUE;
    } else {
