    ...
    <nav class="sidebar-nav">
        <ul class="metismenu">
            ...
            $HmvcMenu2["room_setting"] = array(
                ...
                "room_list_device" => array(
                    //menu name
                    "controller" => "floorplan",
                    "method" => "listRoomDevice",
                    "url" => "room_setting/list-room-device",
                    "permission" => "read"
                        ...
                        if ($this->permission->module($moduleName)->access()) {
                            ...
                            <li class="<?php echo (($this->uri->segment(1) == $moduleName) ? "mm-active" : null) ?>">
                                <a class="has-arrow material-ripple"
                                    href="#"><?php echo (($moduleData['icon'] != null) ? $moduleData['icon'] : null) ?><?php echo display($moduleName); ?><span
                                        class="<?php echo (!in_array($moduleName, $allmenu) ? "badges badges-inline badges-danger text-white mt-1 mr-4" : "") ?>"><?php echo (!in_array($moduleName, $allmenu) ? " Addon" : ""); ?></span></a>
            ...
            <?php if ($this->session->userdata('isAdmin')) { ?>
                ...
                <li class="<?php echo (($this->uri->segment(1) == "autoupdate") ? "mm-active" : null) ?>"><a
                        href="<?php echo base_url('autoupdate') ?>"><i
                            class="ti-reload"></i><?php echo display("autoupdate"); ?></a></li>
